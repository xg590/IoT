...
void _switch() {  
  String s = "<!DOCTYPE html><html><head><title>Light Switch</title></head><body>";
  if (switch_flag) {
    switch_flag = 0; s += "Turn light <a href=\"switch\"><b style=\"font-size:2em\">ON </b></a>";
  } else {
    switch_flag = 1; s += "Turn light <a href=\"switch\"><b style=\"font-size:2em\">OFF</b></a>";
  } 
  s += "</body></html>";
